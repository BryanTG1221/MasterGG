...
<body>
    <div class="contaienr__main">
        ...
        <div class="info-registro">
            ...
            <p class="product-name">RAZER White Viper Mini</p>
            <img id="pc-csgo" src="resources/Mouse/mouse01show.png" alt="PC">
    ...
    function GenerarOrden ($conexion,$usuario,$localtime) {
        ...
        $consultaInsertar = "INSERT INTO ventas(num_orden, fecha_orden, id_Usuario, id_Producto) VALUES ('','$localtime','$valorQuery[0]','8')";
