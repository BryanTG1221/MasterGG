...
<body>
    <div class="contaienr__main">
        ...
        <div class="info-registro">
            ...
            <p class="product-name">GG White PC</p>
            <img id="pc-csgo" src="resources/PC/White/Abyss-Blanco-01.png" alt="PC">
    ...
    <?php
        ...
        function GenerarOrden ($conexion,$usuario,$localtime) {
            ...
            $consultaInsertar = "INSERT INTO ventas(num_orden, fecha_orden, id_Usuario, id_Producto) VALUES ('','$localtime','$valorQuery[0]','2')";
