...
<body>
    <div class="contaienr__main">
        ...
        <div class="info-registro">
            ...
            <p class="product-name">GG Tokio Keyboard</p>
            <img id="pc-csgo" src="resources/Teclados/Teclado_Tokyo_60_1-removebg-preview.png" alt="PC">
    ...
    <?php
        ...
        function GenerarOrden ($conexion,$usuario,$localtime) {
            ...
            $consultaInsertar = "INSERT INTO ventas(num_orden, fecha_orden, id_Usuario, id_Producto) VALUES ('','$localtime','$valorQuery[0]','4')";
