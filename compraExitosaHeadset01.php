...
<body>
    <div class="contaienr__main">
        ...
        <div class="info-registro">
            ...
            <img id="pc-csgo" src="resources/Headset/headsetshow02-removebg-preview.png" alt="PC">
    ...
    function GenerarOrden ($conexion,$usuario,$localtime) {
        ...
        $consultaInsertar = "INSERT INTO ventas(num_orden, fecha_orden, id_Usuario, id_Producto) VALUES ('','$localtime','$valorQuery[0]','10')";
