...
<body>
    <div class="contaienr__main">
        <div class="logo-container">
            ...
            <p class="mastergg-p">Razer Viper Mini Green</p>
        </div>
        <div class="info-registro">
            <h1>!Compra Exitosa!</h1>
            <p class="product-name">RAZER Black Viper Mini</p>
            <img id="mouse-razer-black" src="resources/Mouse/MouseRazer3.png" alt="PC">
    ...
    function GenerarOrden ($conexion,$usuario,$localtime) {
        ...
        $consultaInsertar = "INSERT INTO ventas(num_orden, fecha_orden, id_Usuario, id_Producto) VALUES ('','$localtime','$valorQuery[0]','9')";
